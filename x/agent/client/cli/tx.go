...
func CmdRegister() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long:  "Register as an AI agent on the Cognize network.\nExample: cognized tx agent register \"coding,reasoning\" \"gpt-4\" 100000000000000000000cognize",
...
func CmdAddStake() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long:  "Increase the stake of an already-registered AI agent.\nExample: cognized tx agent add-stake 50000000000000000000cognize",
