...
func ContributionRewardCapForTest(poolAmount, capabilitiesStake, totalEligibleStake *big.Int) *big.Int {
	return contributionRewardCap(poolAmount, capabilitiesStake, totalEligibleStake, 200)
}
