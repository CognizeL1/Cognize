...
type ucapabilitiesStatistics struct {
...
type QueryucapabilitiesStatsRequest struct {
	Address string `json:"address"`
}

type QueryucapabilitiesStatsResponse struct {
	Stats ucapabilitiesStatistics `json:"stats"`
}
...
type QueryTopucapabilitiessRequest struct {
	SortBy string `json:"sort_by"`
	Limit  int    `json:"limit"`
}

type QueryTopucapabilitiessResponse struct {
	ucapabilitiess []ucapabilitiesStatistics `json:"capabilitiess"`
}

type QueryucapabilitiessByCapabilityRequest struct {
	Capabilities []string `json:"capabilities"`
	MatchAll     bool     `json:"match_all"`
}

type QueryucapabilitiessByCapabilityResponse struct {
	ucapabilitiess []ucapabilities `json:"capabilitiess"`
}
...
type QueryucapabilitiesChallengeHistoryRequest struct {
	Address string `json:"address"`
	Limit   uint64 `json:"limit"`
}

type QueryucapabilitiesChallengeHistoryResponse struct {
