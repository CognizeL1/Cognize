...
const (
	...
	ucapabilitiesKeyPrefix            = "ucapabilities/value/"
	ucapabilitiesCountKey             = "ucapabilities/count"
...
func Keyucapabilities(address string) []byte {
	return []byte(ucapabilitiesKeyPrefix + address)
}
