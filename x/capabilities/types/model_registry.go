...
func KeyAIModelByucapabilities(capabilities string) []byte {
	return []byte("aimodel/capabilities/" + capabilities)
}
...
func KeyDatasetByucapabilities(capabilities string) []byte {
	return []byte("dataset/capabilities/" + capabilities)
}
