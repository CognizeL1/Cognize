...
func ContributionRewardCapForTest(poolAmount, channelsStake, totalEligibleStake *big.Int) *big.Int {
	return contributionRewardCap(poolAmount, channelsStake, totalEligibleStake, 200)
}
