...
type ChannelsStatistics struct {
...
type QueryChannelsStatsRequest struct {
	Address string `json:"address"`
}

type QueryChannelsStatsResponse struct {
	Stats ChannelsStatistics `json:"stats"`
}
...
type QueryTopChannelssRequest struct {
	SortBy string `json:"sort_by"`
	Limit  int    `json:"limit"`
}

type QueryTopChannelssResponse struct {
	Channelss []ChannelsStatistics `json:"channelss"`
}

type QueryChannelssByCapabilityRequest struct {
	Capabilities []string `json:"capabilities"`
	MatchAll     bool     `json:"match_all"`
}

type QueryChannelssByCapabilityResponse struct {
	Channelss []Channels `json:"channelss"`
}
...
type QueryChannelsChallengeHistoryRequest struct {
	Address string `json:"address"`
	Limit   uint64 `json:"limit"`
}

type QueryChannelsChallengeHistoryResponse struct {
