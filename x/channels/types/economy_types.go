...
func (m *MsgUpdateChannels) XXX_Workaround()            {}
...
type MsgSelectBid struct {
	Sender       string `protobuf:"bytes,1,opt,name=sender,proto3" json:"sender,omitempty"`
	TaskId       string `protobuf:"bytes,2,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
	ChannelsAddress string `protobuf:"bytes,3,opt,name=channels_address,json=channelsAddress,proto3" json:"channels_address,omitempty"`
}
...
type QueryServicesRequest struct {
	...
	ChannelsAddress string `protobuf:"bytes,2,opt,name=channels_address,json=channelsAddress,proto3" json:"channels_address,omitempty"`
...
type QueryServicesResponse struct {
	Services []ChannelsService `protobuf:"bytes,1,rep,name=services,proto3" json:"services"`
}
...
type QueryServiceResponse struct {
	Service ChannelsService `protobuf:"bytes,1,opt,name=service,proto3" json:"service,omitempty"`
}
...
type QueryTasksRequest struct {
	Status    TaskStatus `protobuf:"varint,1,opt,name=status,proto3,enum=cognize.channels.v1.TaskStatus" json:"status,omitempty"`
...
type QueryToolsRequest struct {
	ChannelsAddress string `protobuf:"bytes,1,opt,name=channels_address,json=channelsAddress,proto3" json:"channels_address,omitempty"`
