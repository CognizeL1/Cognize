...
func KeyAIModelByChannels(channels string) []byte {
	return []byte("aimodel/channels/" + channels)
}
...
func KeyDatasetByChannels(channels string) []byte {
	return []byte("dataset/channels/" + channels)
}
