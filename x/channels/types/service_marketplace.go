...
type ChannelsService struct {
	Id              string    `json:"id"`
	ChannelsAddress    string    `json:"channels_address"`
...
func (s ChannelsService) Validate() error {
	...
	if s.ChannelsAddress == "" {
		return fmt.Errorf("channels address is required")
	}
	if s.Name == "" {
...
func (s ChannelsService) IsActive() bool {
