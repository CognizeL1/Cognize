...
func ContributionRewardCapForTest(poolAmount, inferenceStake, totalEligibleStake *big.Int) *big.Int {
	return contributionRewardCap(poolAmount, inferenceStake, totalEligibleStake, 200)
}
