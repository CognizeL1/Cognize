...
func (m *MsgUpdateuinference) XXX_Workaround()            {}
...
type MsgSelectBid struct {
	Sender       string `protobuf:"bytes,1,opt,name=sender,proto3" json:"sender,omitempty"`
	TaskId       string `protobuf:"bytes,2,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
	uinferenceAddress string `protobuf:"bytes,3,opt,name=inference_address,json=inferenceAddress,proto3" json:"inference_address,omitempty"`
}
...
type QueryServicesRequest struct {
	...
	uinferenceAddress string `protobuf:"bytes,2,opt,name=inference_address,json=inferenceAddress,proto3" json:"inference_address,omitempty"`
...
type QueryServicesResponse struct {
	Services []uinferenceService `protobuf:"bytes,1,rep,name=services,proto3" json:"services"`
}
...
type QueryServiceResponse struct {
	Service uinferenceService `protobuf:"bytes,1,opt,name=service,proto3" json:"service,omitempty"`
}
...
type QueryTasksRequest struct {
	Status    TaskStatus `protobuf:"varint,1,opt,name=status,proto3,enum=cognize.inference.v1.TaskStatus" json:"status,omitempty"`
...
type QueryToolsRequest struct {
	uinferenceAddress string `protobuf:"bytes,1,opt,name=inference_address,json=inferenceAddress,proto3" json:"inference_address,omitempty"`
