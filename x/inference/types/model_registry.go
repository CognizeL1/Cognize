...
func KeyAIModelByuinference(inference string) []byte {
	return []byte("aimodel/inference/" + inference)
}
...
func KeyDatasetByuinference(inference string) []byte {
	return []byte("dataset/inference/" + inference)
}
