...
func GetTxCmd() *cobra.Command {
	txCmd := &cobra.Command{
		...
		Short:                      "Messaging module transactions",
...
func CmdRegister() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "Register as an AI messaging",
		Long:  "Register as an AI messaging on the Axon network.\nExample: axond tx messaging register \"coding,reasoning\" \"gpt-4\" 100000000000000000000aaxon",
...
func CmdAddStake() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "Add stake to an existing AI messaging",
		Long:  "Increase the stake of an already-registered AI messaging.\nExample: axond tx messaging add-stake 50000000000000000000aaxon",
...
func CmdDeregister() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "deregister",
		Short: "Request to deregister as an AI messaging (7-day cooldown)",
		Args:  cobra.NoArgs,
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
...
func CmdUpdateMessaging() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "update [capabilities] [model]",
		Short: "Update messaging capabilities and model",
