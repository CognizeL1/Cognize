...
func ContributionRewardCapForTest(poolAmount, messagingStake, totalEligibleStake *big.Int) *big.Int {
	return contributionRewardCap(poolAmount, messagingStake, totalEligibleStake, 200)
}
