...
type MessagingStatistics struct {
...
type QueryMessagingStatsRequest struct {
	Address string `json:"address"`
}

type QueryMessagingStatsResponse struct {
	Stats MessagingStatistics `json:"stats"`
}
...
type QueryTopMessagingsRequest struct {
	SortBy string `json:"sort_by"`
	Limit  int    `json:"limit"`
}

type QueryTopMessagingsResponse struct {
	Messagings []MessagingStatistics `json:"messagings"`
}

type QueryMessagingsByCapabilityRequest struct {
	Capabilities []string `json:"capabilities"`
	MatchAll     bool     `json:"match_all"`
}

type QueryMessagingsByCapabilityResponse struct {
	Messagings []Messaging `json:"messagings"`
}
...
type QueryMessagingChallengeHistoryRequest struct {
	Address string `json:"address"`
	Limit   uint64 `json:"limit"`
}

type QueryMessagingChallengeHistoryResponse struct {
