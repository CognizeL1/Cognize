...
func (m *MsgUpdateMessaging) XXX_Workaround()            {}
...
type MsgSelectBid struct {
	Sender       string `protobuf:"bytes,1,opt,name=sender,proto3" json:"sender,omitempty"`
	TaskId       string `protobuf:"bytes,2,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
	MessagingAddress string `protobuf:"bytes,3,opt,name=messaging_address,json=messagingAddress,proto3" json:"messaging_address,omitempty"`
}
...
type QueryServicesRequest struct {
	...
	MessagingAddress string `protobuf:"bytes,2,opt,name=messaging_address,json=messagingAddress,proto3" json:"messaging_address,omitempty"`
...
type QueryServicesResponse struct {
	Services []MessagingService `protobuf:"bytes,1,rep,name=services,proto3" json:"services"`
}
...
type QueryServiceResponse struct {
	Service MessagingService `protobuf:"bytes,1,opt,name=service,proto3" json:"service,omitempty"`
}
...
type QueryTasksRequest struct {
	Status    TaskStatus `protobuf:"varint,1,opt,name=status,proto3,enum=cognize.messaging.v1.TaskStatus" json:"status,omitempty"`
...
type QueryToolsRequest struct {
	MessagingAddress string `protobuf:"bytes,1,opt,name=messaging_address,json=messagingAddress,proto3" json:"messaging_address,omitempty"`
