...
func KeyAIModelByMessaging(messaging string) []byte {
	return []byte("aimodel/messaging/" + messaging)
}
...
func KeyDatasetByMessaging(messaging string) []byte {
	return []byte("dataset/messaging/" + messaging)
}
