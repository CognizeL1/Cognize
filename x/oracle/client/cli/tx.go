...
func GetTxCmd() *cobra.Command {
	txCmd := &cobra.Command{
		...
		Short:                      "Oracle module transactions",
...
func CmdRegister() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "Register as an AI oracle",
		Long:  "Register as an AI oracle on the Axon network.\nExample: axond tx oracle register \"coding,reasoning\" \"gpt-4\" 100000000000000000000aaxon",
...
func CmdAddStake() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "Add stake to an existing AI oracle",
		Long:  "Increase the stake of an already-registered AI oracle.\nExample: axond tx oracle add-stake 50000000000000000000aaxon",
...
func CmdDeregister() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "deregister",
		Short: "Request to deregister as an AI oracle (7-day cooldown)",
		Args:  cobra.NoArgs,
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
...
func CmdUpdateOracle() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "Update oracle capabilities and model",
