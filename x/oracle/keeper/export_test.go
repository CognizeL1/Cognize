...
func ContributionRewardCapForTest(poolAmount, oracleStake, totalEligibleStake *big.Int) *big.Int {
	return contributionRewardCap(poolAmount, oracleStake, totalEligibleStake, 200)
}
