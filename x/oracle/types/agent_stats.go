...
type QueryOracleStatsRequest struct {
	Address string `json:"address"`
}

type QueryOracleStatsResponse struct {
	Stats OracleStatistics `json:"stats"`
}
...
type QueryTopOraclesRequest struct {
	SortBy string `json:"sort_by"`
	Limit  int    `json:"limit"`
}

type QueryTopOraclesResponse struct {
	Oracles []OracleStatistics `json:"oracles"`
}

type QueryOraclesByCapabilityRequest struct {
	Capabilities []string `json:"capabilities"`
	MatchAll     bool     `json:"match_all"`
}

type QueryOraclesByCapabilityResponse struct {
...
type QueryOracleChallengeHistoryRequest struct {
	Address string `json:"address"`
	Limit   uint64 `json:"limit"`
}

type QueryOracleChallengeHistoryResponse struct {
