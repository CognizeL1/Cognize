...
func KeyAIModelByOracle(oracle string) []byte {
	return []byte("aimodel/oracle/" + oracle)
}
...
func KeyDatasetByOracle(oracle string) []byte {
	return []byte("dataset/oracle/" + oracle)
}
