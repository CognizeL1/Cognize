...
// - protoc             (unknown)
// source: axon/oracle/v1/query.proto
...
const (
	Query_Params_FullMethodName           = "/axon.oracle.v1.Query/Params"
	Query_Oracle_FullMethodName            = "/axon.oracle.v1.Query/Oracle"
	Query_Oracles_FullMethodName           = "/axon.oracle.v1.Query/Oracles"
	Query_Reputation_FullMethodName       = "/axon.oracle.v1.Query/Reputation"
	Query_CurrentChallenge_FullMethodName = "/axon.oracle.v1.Query/CurrentChallenge"
)
...
func (c *queryClient) Oracle(ctx context.Context, in *QueryOracleRequest, opts ...grpc.CallOption) (*QueryOracleResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Oracle_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Oracles(ctx context.Context, in *QueryOraclesRequest, opts ...grpc.CallOption) (*QueryOraclesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Oracles_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) Oracle(context.Context, *QueryOracleRequest) (*QueryOracleResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Oracle not implemented")
}
func (UnimplementedQueryServer) Oracles(context.Context, *QueryOraclesRequest) (*QueryOraclesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Oracles not implemented")
}
...
var Query_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "axon.oracle.v1.Query",
	...
	Metadata: "axon/oracle/v1/query.proto",
}
