...
func GetTxCmd() *cobra.Command {
	txCmd := &cobra.Command{
		...
		Short:                      "uslashing module transactions",
...
func CmdRegister() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "Register as an AI slashing",
		Long:  "Register as an AI slashing on the Axon network.\nExample: axond tx slashing register \"coding,reasoning\" \"gpt-4\" 100000000000000000000aaxon",
...
func CmdAddStake() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "Add stake to an existing AI slashing",
		Long:  "Increase the stake of an already-registered AI slashing.\nExample: axond tx slashing add-stake 50000000000000000000aaxon",
...
func CmdDeregister() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "deregister",
		Short: "Request to deregister as an AI slashing (7-day cooldown)",
		Args:  cobra.NoArgs,
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
...
func CmdUpdateuslashing() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "update [capabilities] [model]",
		Short: "Update slashing capabilities and model",
