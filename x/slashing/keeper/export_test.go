...
func ContributionRewardCapForTest(poolAmount, slashingStake, totalEligibleStake *big.Int) *big.Int {
	return contributionRewardCap(poolAmount, slashingStake, totalEligibleStake, 200)
}
