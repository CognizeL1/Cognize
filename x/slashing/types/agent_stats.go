...
type uslashingStatistics struct {
...
type QueryuslashingStatsRequest struct {
	Address string `json:"address"`
}

type QueryuslashingStatsResponse struct {
	Stats uslashingStatistics `json:"stats"`
}
...
type QueryTopuslashingsRequest struct {
	SortBy string `json:"sort_by"`
	Limit  int    `json:"limit"`
}

type QueryTopuslashingsResponse struct {
	uslashings []uslashingStatistics `json:"slashings"`
}

type QueryuslashingsByCapabilityRequest struct {
	Capabilities []string `json:"capabilities"`
	MatchAll     bool     `json:"match_all"`
}

type QueryuslashingsByCapabilityResponse struct {
	uslashings []uslashing `json:"slashings"`
}
...
type QueryuslashingChallengeHistoryRequest struct {
	Address string `json:"address"`
	Limit   uint64 `json:"limit"`
}

type QueryuslashingChallengeHistoryResponse struct {
