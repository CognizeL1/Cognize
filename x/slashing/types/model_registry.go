...
func KeyAIModelByuslashing(slashing string) []byte {
	return []byte("aimodel/slashing/" + slashing)
}
...
func KeyDatasetByuslashing(slashing string) []byte {
	return []byte("dataset/slashing/" + slashing)
}
