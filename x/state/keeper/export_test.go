...
func ContributionRewardCapForTest(poolAmount, stateStake, totalEligibleStake *big.Int) *big.Int {
	return contributionRewardCap(poolAmount, stateStake, totalEligibleStake, 200)
}
