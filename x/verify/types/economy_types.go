...
func (m *MsgUpdateVerify) XXX_Workaround()            {}
...
type MsgSelectBid struct {
	Sender       string `protobuf:"bytes,1,opt,name=sender,proto3" json:"sender,omitempty"`
	TaskId       string `protobuf:"bytes,2,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
	VerifyAddress string `protobuf:"bytes,3,opt,name=verify_address,json=verifyAddress,proto3" json:"verify_address,omitempty"`
}
...
type QueryServicesRequest struct {
	...
	VerifyAddress string `protobuf:"bytes,2,opt,name=verify_address,json=verifyAddress,proto3" json:"verify_address,omitempty"`
...
type QueryServicesResponse struct {
	Services []VerifyService `protobuf:"bytes,1,rep,name=services,proto3" json:"services"`
}
...
type QueryServiceResponse struct {
	Service VerifyService `protobuf:"bytes,1,opt,name=service,proto3" json:"service,omitempty"`
}
...
type QueryTasksRequest struct {
	Status    TaskStatus `protobuf:"varint,1,opt,name=status,proto3,enum=cognize.verify.v1.TaskStatus" json:"status,omitempty"`
...
type QueryToolsRequest struct {
	VerifyAddress string `protobuf:"bytes,1,opt,name=verify_address,json=verifyAddress,proto3" json:"verify_address,omitempty"`
