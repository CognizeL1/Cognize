...
func KeyAIModelByVerify(verify string) []byte {
	return []byte("aimodel/verify/" + verify)
}
...
func KeyDatasetByVerify(verify string) []byte {
	return []byte("dataset/verify/" + verify)
}
